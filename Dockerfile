#
#
# Build: docker build --rm --tag montereytony/ubga136
# Push: docker tag my_image $DOCKER_ID_USER/my_image
#
# git status
# git commit -m "comments Intro to Financial Engineering"
# git push
#
...
RUN Rscript -e "install.packages('https://cran.r-project.org/src/contrib/caTools_1.17.1.2.tar.gz',repos=NULL,dependencies = TRUE)"
